...
export default function CheckoutPage() {
    ...
    return (
      <main className="mx-auto flex min-h-[70vh] max-w-xl flex-col items-center justify-center px-4 text-center">
        ...
        <p className="mt-2 text-gray-500">
          Adicione uma fragrância antes de continuar.
        </p>
        <Link
          href="/produtos"
          className="mt-6 rounded-xl bg-[#5b2333] px-5 py-3 font-medium text-white"
        >
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // O próximo bloco transformará este resultado em uma tela
      // de pagamento PIX com QR Code e acompanhamento do pedido.
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
      <div className="mb-8">
        ...
        <h1 className="mt-2 font-serif text-4xl">Finalizar compra</h1>
        <p className="mt-2 text-sm text-gray-500">
          Entrega, desconto e resumo do pedido.
        </p>
      </div>
